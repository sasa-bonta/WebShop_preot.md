...
class OrderApiController extends AbstractController
{
    ...
    /**
     * @Route("/", name="order_api_index", methods={"GET"})
     */
    public function index(Request $request, OrderRepository $orderRepository): JsonResponse
    {
        ...
        foreach ($orderRepository->search($searchOrder) as $order) {
            echo json_encode($order);
        }
        die;
        return $this->json($orderRepository->search($searchOrder));
    }

    /**
     * @Route("/new", name="order_api_new", methods={"POST"})
     */
    public function new(Request $request, CartItemRepository $cartRepository, ProductRepository $productRepository): JsonResponse
    {
        $user = $this->getUser();
        $order = new Order();
    ...
    /**
     * @Route("/{id}/edit", name="order_api_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="order_api_delete", methods={"POST"})
     */
    public function delete(Request $request, Order $order, OrderItemRepository $itemRepository, ProductRepository $productRepository): JsonResponse
    {
    ...
    /**
     * @Route("/next/{id}", name="order_api_next_status", methods={"POST"})
     */
    ...
    /**
     * @Route("/prev/{id}", name="order_api_prev_status", methods={"POST"})
     */
    public function prevStatus(Request $request, Order $order): JsonResponse
    {
